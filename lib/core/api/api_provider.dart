...
abstract class ApiProvider {
  Future<Either<DioError, Response>> get(APIRequestParam param);
  Future<Either<DioError, Response>> post(APIRequestParam param);
  Future<Either<DioError, Response>> put(APIRequestParam param);
  Future<Either<DioError, Response>> patch(APIRequestParam param);
  Future<Either<DioError, Response>> delete(APIRequestParam param);
}
...
class AppApiProvider implements ApiProvider {
  ...
  @override
  Future<Either<DioError, Response>> delete(APIRequestParam param) async {
  ...
  @override
  Future<Either<DioError, Response>> get(APIRequestParam param) async {
  ...
  @override
  Future<Either<DioError, Response>> patch(APIRequestParam param) async {
  ...
  @override
  Future<Either<DioError, Response>> post(APIRequestParam param) async {
  ...
  @override
  Future<Either<DioError, Response>> put(APIRequestParam param) async {
...
//# Post Api with Token
  ...
  //# Post Api with Token
  // Future<Either<DioError, Response>> postCallWithTokenMultiPath({
  //   data,
  //   url,
  // }) async {
  //   log(data.toString());
...
//   // ## Get Api With Token
//   Future<Either<DioError, Response>> deleteCallWithToken(
//       {required String url, dynamic params}) async {
//     var token = await SecureStorageService().readValue(key: AUTH_TOKEN_KEY);
